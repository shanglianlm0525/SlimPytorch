...
from SlimPytorch.quantization.quant_utils import get_input_sequences, replace_quant_ops, \
    register_fuse_params_to_prev_layers, fuse_model, run_calibration, set_quant_mode
