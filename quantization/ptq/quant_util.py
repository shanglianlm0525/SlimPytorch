...
from SlimPytorch.quantization.ptq.quant_module import QConv2d, QIdentity, QLinear
...
def fuse_model(model, w_scheme, w_bit, b_bit, a_scheme, a_bit):
    ...
    replace_quant_ops(model, w_scheme, w_bit, b_bit, a_scheme, a_bit)
